...
import { Alert, Combo, File_Managment, Parameters, ResponseApi } from '@shared/models';
import { TranslateModule } from '@ngx-translate/core';
import { ContactsService, FileManagmentService, AuthService, EncryptionService,  } from '@shared/services';
import { AgGridAngular } from 'ag-grid-angular';
import { ColDef,  ICellRendererParams, RowSelectionMode, RowSelectionOptions, colorSchemeDarkBlue, colorSchemeLight, themeQuartz } from 'ag-grid-enterprise';
...
import { FileModeldocumentsModalComponent } from '../file-modeldocuments-modal/file-modeldocuments-modal.component'
...
@Component({
  selector: 'app-file-modeldocuments',
  standalone: true,
  imports: [
    NzCardModule,
    TranslateModule,
  ...
  templateUrl: './file-modeldocuments.component.html',
  styleUrl: './file-modeldocuments.component.scss'
})
export class FileModeldocumentsComponent {

  private _fileManagment:File_Managment=<File_Managment>{};
  private _id:number;
  public arrCombo: { [key: string]: Array<Parameters> } = {};
  ...
  constructor(
    ...
    public colDefs: ColDef<any>[] = [
        ...
        { field: "actions", headerName: this.translateService.instant("Actions"),cellRenderer: DocTableActionsComponent,  floatingFilter: false, filter: false, width: 50 }
      ];
      ...
      loadModelDocs() {
        ...
        this.modelDocumentsService.loadFileTemplatesByFilemanagment(this.id).subscribe(result => {
          ...
          console.log(this.rowDataModelDocuments);
        });
    ...
    showModal(id?): void {
          this.modalZService.create({
            nzTitle: this.translateService.instant("Model documents"),
            nzContent: FileModeldocumentsModalComponent,
            nzWidth: '1032px',
            nzData: {
              value: id,
              fileManagment: this._fileManagment
            },
            nzFooter: []
          });
    }
