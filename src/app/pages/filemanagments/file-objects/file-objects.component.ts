...
import { File_Objects, ResponseApi, Requests, Combo, File_Managment, Point } from '@shared/models';
...
//import Point, * as EsriPoint from '@arcgis/core/geometry/Point';

@Component({
  selector: 'app-file-objects',
  standalone: true,
  ...
  templateUrl: './file-objects.component.html',
  styleUrl: './file-objects.component.scss'
})
  
export class FileObjectsComponent implements OnInit {
    ...
    columns = [
      { name: 'preview', headerName: this.translateService.instant("Preview"), show: true, disabled:true },
      { name: 'region', headerName: this.translateService.instant("Region"), show: true, disabled:true },
      { name: 'municipality', headerName: this.translateService.instant("Municipality"), show: true, disabled:true },
      { name: 'department', headerName: this.translateService.instant("Department"), show: true, disabled:true },
      { name: 'section', headerName: this.translateService.instant("Section"), show: true, disabled:true },
      { name: 'type_prospection', headerName: this.translateService.instant("Type Prospection"), show: true, disabled:false },
      { name: 'type_parcel', headerName: this.translateService.instant("Type Parcel"), show: true, disabled:false },
      { name: 'area_from', headerName: this.translateService.instant("Area From"), show: true, disabled:false },
      { name: 'area_to', headerName: this.translateService.instant("Area To"), show: true, disabled:false },
      { name: 'object_id', headerName: this.translateService.instant("Object Id"), show: false, disabled:false },
      { name: 'capakey', headerName: this.translateService.instant("Capakey"), show: true, disabled:false },
      { name: 'area', headerName: this.translateService.instant("Area"), show: true, disabled:false },
      { name: 'type_area', headerName: this.translateService.instant("Type Area"), show: false, disabled:false },
      { name: 'type', headerName: this.translateService.instant("Type"), show: false, disabled:false },
      { name: 'status', headerName: this.translateService.instant("Status"), show: false, disabled:false },
      { name: 'address', headerName: this.translateService.instant("Address"), show: true, disabled:false },
      { name: 'gewestplan', headerName: this.translateService.instant("Gewestplan"), show: true , disabled:false},
      { name: 'request', headerName: this.translateService.instant("Request"), show: true , disabled:true},    
      { name: 'environment', headerName: this.translateService.instant("Envvironment"), show: true, disabled:true },
      { name: 'remove', headerName: this.translateService.instant("Remove"), show: true, disabled:true },
    ];
  ...
  changeAddress(event){
    ...
    this.form.get('capakeyAdress').setValue(event.name);
  }
  ...
  private selectAdress(event){   
    ...
    this.mapService.SendGetProxy(sURL).subscribe((dataResponse:any)=>{
      if (dataResponse.candidates!=undefined){
  ...
  public searchFromPoint(oPoint: Point) {
    this.mapService.LoadDataFromPoint(oPoint,"4326","3857").subscribe(async (data: any) => {
      if (data.features != null) {
        this._capaKey=data.features[0].attributes.CaPaKey;  
  ...
  private async loadAddressByCapakey(sCapa){
   ...
   // [MD] New design additions
       ...
       showModal(fileManagement?): void {

             this.modalZService.create({
               nzTitle: this.translateService.instant("Objects"),
       ...
       addDocument(id?): void {
         this.modalZService.create({
           nzTitle: this.translateService.instant("Add a model document"),
